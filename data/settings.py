...
sound01 = pygame.mixer.Sound("audio/win-ding.ogg")
sound01.set_volume(0.7)
sound02 = pygame.mixer.Sound("audio/lose-ding.ogg")
sound02.set_volume(1)
sound03 = pygame.mixer.Sound("audio/lose-ding.ogg")
sound03.set_volume(1)
sound04 = pygame.mixer.Sound("audio/lose-ding.ogg")
sound04.set_volume(1)
sound05 = pygame.mixer.Sound("audio/lose-ding.ogg")
sound05.set_volume(1)
sound06 = pygame.mixer.Sound("audio/lose-ding.ogg")
sound06.set_volume(1)
sound07 = pygame.mixer.Sound("audio/lose-ding.ogg")
